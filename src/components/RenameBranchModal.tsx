...
export function RenameBranchModal({ isOpen, currentName, onClose, onRename }: RenameBranchModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-sm mx-4 bg-card border border-border rounded-xl shadow-2xl animate-in fade-in-0 zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border">
          <h2 className="text-lg font-semibold text-foreground">Rename Branch</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-5 py-4">
          <label htmlFor="rename-branch" className="block text-sm font-medium text-foreground mb-2">
            Branch name
          </label>
          <Input
            id="rename-branch"
